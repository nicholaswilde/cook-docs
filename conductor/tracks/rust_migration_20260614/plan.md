...
- [ ] Task: Create branch and update configuration docs
    - [ ] Create and checkout development branch `migrate-to-rust`
    - [ ] Update `conductor/tech-stack.md` to document the transition to Rust, Cargo, clap, figment, and cooklang
